// ABOUTME: Validates and resolves waiting-for items when files or line numbers change.
// ABOUTME: Uses exact match first, then searches file for matching content.

import { App, TFile } from "obsidian";
import { WaitingForItem } from "./waiting-for-scanner";
...
export class WaitingForValidator {
  constructor(private app: App) {}

  async validateItem(item: WaitingForItem): Promise<ValidationResult> {
