...
- **Current Approach**: `FlowProjectScanner.scanProjects` retrieves all markdown files and filters them by tags. It then reads the content of _all_ identified project files to extract next actions.
